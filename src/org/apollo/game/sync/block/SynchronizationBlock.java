...
public abstract class SynchronizationBlock {
	 ...
	 */
	public static SynchronizationBlock createPlayerAppearanceBlock(Player player) {
	 ...
	 */
	public static SynchronizationBlock createPlayerChatBlock(Player player, ChatEvent chatEvent) {
	 ...
	 */
	public static SynchronizationBlock createPlayerAnimationBlock(Animation animation) {
	 ...
	 */
	public static SynchronizationBlock creatPlayereGraphicBlock(Graphic graphic) {
	 ...
	 */
	public static SynchronizationBlock createPlayerTurnToPositionBlock(Position position) {
