...
public abstract class Character {
	...
	public void playAnimation(Animation animation) {
		blockSet.add(SynchronizationBlock.createPlayerAnimationBlock(animation));
	}
	...
	public void playGraphic(Graphic graphic) {
		blockSet.add(SynchronizationBlock.creatPlayereGraphicBlock(graphic));
	}
	...
	public void turnTo(Position position) {
		blockSet.add(SynchronizationBlock.createPlayerTurnToPositionBlock(position));
	}
